<div class="slide story" id="slide-1" ng-controller="MainCtrl">
	<div class="container">
		...
		<div class="row">
			...
			<% else %>
			<div class="col-sm-12 gray-box" style="background:url('assets/Services/REV3-Header-and-Body-Images-for-the-Text-in-the-6-Services-on-the-Main-Service-Page/REV3earlystage-body-2-889x448.png');background-size:cover;background-position: 100% 100%;">
				<div class="content-text">
				$Content
				</div>
			</div>
