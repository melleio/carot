...
<div id="myCarousel" class="container slider">
    ...
    <!-- prev / next controls -->
    <a class="left carousel-control" href="#myCarousel" data-slide="prev" ng-click="showPrev()"><i style="padding-top:200px" class="fa fa-arrow-circle-left"></i></a>
	<a class="right carousel-control" href="#myCarousel" data-slide="next" ng-click="showNext()"><i style="padding-top:200px" class="fa fa-arrow-circle-right"></i></a>
