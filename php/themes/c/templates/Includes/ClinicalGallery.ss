...
<div id="myCarousel" class="container slider">
    ...
    <!-- prev / next controls -->
    <a class="left carousel-control ng-hide" href="#myCarousel" data-slide="prev" ng-click="showPrev()" ng-hide=""><i style="padding-top:180px" class="fa fa-arrow-circle-left"></i></a>
