<?php
class TranslationalServicesItem extends TranslationalServices {
...
class TranslationalServicesItem_Controller extends TranslationalServices_Controller {
	...
	public function index(){
		...
		return $this->renderWith(array('ResearchPage','TranslationalServicesItem'));
	}
